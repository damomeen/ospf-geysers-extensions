...
#define OSPF_LSA_PREMATURE_AGE    0x40
  ...
  /** Prevents endles FEED UP / FEED DOWN loops */
  u_char instance_copy;
#define OSPF_LSA_FROM_INNI_COPY   0x01
#define OSPF_LSA_FROM_ENNI_COPY   0x02
#define OSPF_LSA_FROM_UNI_COPY    0x04
