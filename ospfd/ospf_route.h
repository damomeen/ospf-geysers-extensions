...
extern struct ospf_path *ospf_path_lookup (struct zlist *, struct ospf_path *);
...
extern int ospf_route_cmp (struct ospf *, struct ospf_route *,
			   struct ospf_route *);
extern void ospf_route_copy_nexthops (struct ospf_route *, struct zlist *);
...
extern void ospf_route_subst_nexthops (struct ospf_route *, struct zlist *);
