...
#ifdef HAVE_OMNIORB
#define thread_execute_no_lock(m,f,a,v) funcname_thread_execute_no_lock(m,f,a,v,#f)
#endif /* HAVE_OMNIORB */
...
#ifdef HAVE_OMNIORB
extern struct thread *funcname_thread_execute_no_lock (struct thread_master *,
                                               int (*)(struct thread *),
                                               void *, int, const char *);
extern void thread_call_no_lock (struct thread *);
#endif /* HAVE_OMNIORB */
