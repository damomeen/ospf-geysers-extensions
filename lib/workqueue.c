...
static struct zlist work_queues;
...
static void
work_queue_item_remove (struct work_queue *wq, struct zlistnode *ln)
{
...
static void
work_queue_item_requeue (struct work_queue *wq, struct zlistnode *ln)
{
