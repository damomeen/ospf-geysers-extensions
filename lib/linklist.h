...
struct zlist
{
  struct zlistnode *head;
  struct zlistnode *tail;
...
/* Prototypes. */
extern struct zlist *list_new(void); /* encouraged: set list.del callback on new lists */
extern void list_free (struct zlist *);

extern void listnode_add (struct zlist *, void *);
extern void listnode_add_sort (struct zlist *, void *);
extern void listnode_add_after (struct zlist *, struct zlistnode *, void *);
extern void listnode_delete (struct zlist *, void *);
extern void listnode_delete_with_data (struct zlist *, void *);
extern struct zlistnode *listnode_lookup (struct zlist *, void *);
extern void *listnode_head (struct zlist *);

extern void list_delete (struct zlist *);
extern void list_delete_all_node (struct zlist *);

/* For ospfd and ospf6d. */
extern void list_delete_node (struct zlist *, struct zlistnode *);

/* For ospf_spf.c */
extern void list_add_node_prev (struct zlist *, struct zlistnode *, void *);
extern void list_add_node_next (struct zlist *, struct zlistnode *, void *);
extern void list_add_list (struct zlist *, struct zlist *);
