...
#ifdef GMPLS
DEFUN (show_memory_scngws,
       show_memory_scngws_cmd,
       "show memory scngws",
       SHOW_STR
       "Memory statistics\n"
       "SCNGWS memory\n")
{
	show_memory_vty(vty, memory_list_scngws);
	return CMD_SUCCESS;
}

DEFUN (show_memory_lrm,
       show_memory_lrm_cmd,
       "show memory lrm",
       SHOW_STR
       "Memory statistics\n"
       "LRM memory\n")
{
	show_memory_vty(vty, memory_list_lrm);
	return CMD_SUCCESS;
}

DEFUN (show_memory_g2pceravty,
       show_memory_g2pceravty_cmd,
       "show memory g2pceravty",
       SHOW_STR
       "Memory statistics\n"
       "G2PCERAVTY memory\n")
{
	show_memory_vty(vty, memory_list_g2pceravty);
	return CMD_SUCCESS;
}

DEFUN (show_memory_g2rsvptevty,
       show_memory_g2rsvptevty_cmd,
       "show memory g2rsvptevty",
       SHOW_STR
       "Memory statistics\n"
       "G2RSVPTEVTY memory\n")
{
        show_memory_vty(vty, memory_list_g2rsvptevty);
        return CMD_SUCCESS;
}

DEFUN (show_memory_ncc,
       show_memory_ncc_cmd,
       "show memory ncc",
       SHOW_STR
       "Memory statistics\n"
       "NCC memory\n")
{
	show_memory_vty(vty, memory_list_ncc);
	return CMD_SUCCESS;
}

DEFUN (show_memory_gunigw,
       show_memory_gunigw_cmd,
       "show memory gunigw",
       SHOW_STR
       "Memory statistics\n"
       "GUNIGW memory\n")
{
	show_memory_vty(vty, memory_list_gunigw);
	return CMD_SUCCESS;
}

DEFUN (show_memory_tnrc,
       show_memory_tnrc_cmd,
       "show memory tnrc",
       SHOW_STR
       "Memory statistics\n"
       "TNRC memory\n")
{
	show_memory_vty(vty, memory_list_tnrc);
	return CMD_SUCCESS;
}
#endif /* GMPLS */
...
#ifdef GMPLS
  install_element (VIEW_NODE, &show_memory_scngws_cmd);
  install_element (VIEW_NODE, &show_memory_lrm_cmd);
  install_element (VIEW_NODE, &show_memory_g2pceravty_cmd);
  install_element (VIEW_NODE, &show_memory_ncc_cmd);
  install_element (VIEW_NODE, &show_memory_g2rsvptevty_cmd);
  install_element (VIEW_NODE, &show_memory_gunigw_cmd);
  install_element (VIEW_NODE, &show_memory_tnrc_cmd);
#endif /* GMPLS */
...
#ifdef GMPLS
  install_element (ENABLE_NODE, &show_memory_scngws_cmd);
  install_element (ENABLE_NODE, &show_memory_lrm_cmd);
  install_element (ENABLE_NODE, &show_memory_g2pceravty_cmd);
  install_element (ENABLE_NODE, &show_memory_ncc_cmd);
  install_element (ENABLE_NODE, &show_memory_g2rsvptevty_cmd);
  install_element (ENABLE_NODE, &show_memory_gunigw_cmd);
  install_element (ENABLE_NODE, &show_memory_tnrc_cmd);
#endif /* GMPLS */
}

