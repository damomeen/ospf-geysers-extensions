...
struct zclient
{
  ...
  int (*interface_te_update) (int, struct zclient *, uint16_t);
...
#ifdef GMPLS
#if !HAVE_OMNIORB
  int (*begin_sync) (int, struct zclient *, uint16_t);
  int (*end_sync) (int, struct zclient *, uint16_t);
  int (*scnif_add) (int, struct zclient *, uint16_t);
  int (*scnif_delete) (int, struct zclient *, uint16_t);	
  int (*tel_cc_assoc_add) (int, struct zclient *, uint16_t);
  int (*tel_cc_assoc_update) (int, struct zclient *, uint16_t);
  int (*tel_cc_assoc_delete) (int, struct zclient *, uint16_t);
  int (*cc_scnif_assoc_add) (int, struct zclient *, uint16_t);
  int (*cc_scnif_assoc_update) (int, struct zclient *, uint16_t);
  int (*cc_scnif_assoc_delete) (int, struct zclient *, uint16_t);
  int (*sync_fatal_error) (int, struct zclient *, uint16_t);
  int (*lrm_connection_down) (struct zclient *);
#endif /* !HAVE_OMNIORB */
#endif /*GMPLS*/
};
...
#ifdef GMPLS
extern void zclient_init (struct zclient *, int, int);
#else
...
extern int zclient_socket (struct zclient *);
...
extern uint16_t zebra_router_id_update_read (struct stream *s, struct prefix *rid, uint32_t* energyConsumption);
extern struct interface * zebra_interface_update_read (struct stream *s);
